...
public class FuShu {
	...
	public FuShu add(FuShu other){
		...
		return new FuShu(a+other.a,b+other.b);
	...
	/*public 实验五FuShu add(实验五FuShu fs1,实验五FuShu fs2){
		return new 实验五FuShu(fs1.a+fs2.a,fs1.b+fs2.b);
	}*/
	public static void main(String[] args) {
        ...
        FuShu fs5 = new FuShu();
       // 实验五FuShu s2 = fs5.add(new 实验五FuShu(1,2),new 实验五FuShu(3,5));
